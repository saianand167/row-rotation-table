  ...
  return (
    <div className="max-w-md mx-auto mt-8 animate-fade-in-up">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">To-Do & Progress</h1>
        <p className="text-sm text-gray-500 mt-1">Manage your tasks, track your progress</p>
      </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all"
                  autoFocus
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all pr-12"
                  autoComplete="current-password"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-[calc(50%+8px)] text-gray-400 hover:text-gray-600 transition-colors"
                >
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  autoComplete="username"
                />
                <p className="text-[10px] text-gray-400 mt-1">3-30 characters. Letters, numbers, underscores only.</p>
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Password</label>
                <input
